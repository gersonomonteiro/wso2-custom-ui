...
<html>
    <head>
        <!-- header -->
        <%
            File headerFile = new File(getServletContext().getRealPath("extensions/mobile_header.jsp"));
    ...
    <body class="email-otp-portal-layout">
                    ...
                    <div class="form-login">
                        ...
                        <div class="segment-form login-form">
                            <form class="ui large form" id="codeForm" name="codeForm" action="../commonauth" method="POST">
                                ...
                                <div class="field">
                                    <label for="password">Your account is protected with two-factor verification. Please enter the two-factor code we sent to the email ID
                                        (<%=Encode.forHtmlContent(request.getParameter("screenValue"))%>)
                                    </label>
                                    <input type="password" id='OTPCode' name="OTPCode" c size='30' class="form-control"/>
                                <% } else { %>
                                <div class="field">
                                    <label for="password">Your account is protected with two-factor verification. Please enter the two-factor code we sent to the email ID:</label>
                                ...
                                <div class="align-right buttons">
                                    ...
                                    <input type="button" name="authenticate" id="authenticate" value="<%=IdentityManagementEndpointUtil.i18n(recoveryResourceBundle, "authenticate")%>"
                                        class="ui primary button grey-bg" />
                                </div>
                            </form>
                        </div>
                    </div>
